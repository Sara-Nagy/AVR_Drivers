...
{    
	...
	DIO_VoidSetLowNibbleValue(KEYPAD_PORT,0xF0);  // set internal pull up resistor in high nibble
	
	
     /*
	 //low nibble :OUTPUT (Columns)
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN0,DIO_OUT); //c1
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN1,DIO_OUT); //c2
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN2,DIO_OUT); //c3
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN3,DIO_OUT); //c4
	...
	//high nibble :INPUT (Rows)
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN4,DIO_IN); //r1
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN5,DIO_IN); //r2
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN6,DIO_IN); //r3
	 DIO_VoidSetPinDirection(KEYPAD_PORT,DIO_PIN7,DIO_IN); //r4
...
u8 KEYPAD_U8Check_PressedKey(void)
{
	...
	for(column=0;column<KEYPAD_COLUMNS;column++)
	{
		...
		{ 
			if(DIO_U8GetPinValue(KEYPAD_PORT,row+4)==DIO_LOW)
